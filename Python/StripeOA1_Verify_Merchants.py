# '''
# Verify individual and company infomation
# Input:
# - first line of your input will represent the number of remaining input lines, 
# - Each following line will be ni the form merchant_id,field_name,field_value
# - merchant_id is a unique identifier for the merchain. One or more merchants will be indluced in your input
# - field_name will either be country or business_type, or one of the values from the table below shuch as first_name or support_email

# Individuals (x means required)      |    Company                 US  JP  FR
#                         US  JP  FR  |    name                    X   X   X  
# first_name              x   x   x   |    director_name                   X
# last_name               x   x   x   |    employer_id_number      X    
# first_name_kana             x       |    tax_id_number               X   X     
# last_name_kana              x       |    support_email           X
# date_of birth           x   x       |    phone                   X   X   X
...
# Output:
# - Print one line per merchant_id to standard output, in lexicographical order
# - If required fields have been provided accourding to the country and business_type, print merchant_id:VERIFIED
# - Otherwise, print merchant_id:UNVERIFIED:fields_needed

# Example 1:
# Input:                              output:
# 1                                   acct_123:UNVERIFIED:country
# acct_123,business_type,company

# Example 2:                          Output
# 12                                  acct_123:UNVERIFIED:director_name,name,phone         
# acct_123,tax_id_number,123456688    acct_456:VERIFIED
# acct_123,countr,FR
# acct_123,business_type,company
...
# acct_456,tax_id_number,123456677
# acct_456,email,text@example.com
# '''
